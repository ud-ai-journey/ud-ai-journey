...
<div style='background: linear-gradient(90deg, #4f8cff 0%, #38e8ff 100%); padding: 1rem 0; border-radius: 8px; text-align: center; margin-bottom: 1rem;'>
    ...
    <span style='color: #fff; font-size: 1.1rem;'>Empowering Teachers in Multi-Grade Classrooms &mdash; Agentic AI Day Hackathon 2025</span>
</div>
...
st.info("""
**About this Project:**  
This is a special hackathon edition of ClassGenie, rebranded as **GURU SAHAYAM** for the Agentic AI Day 2025. It is designed to empower teachers in multi-grade, multi-lingual, and culturally diverse classrooms across India.  
